...
The `separator` key is a region specific setting from experimentation it seems that in the US and Canada, this should be a comma, but in Europe it should be a semicolon. It mainly appears in the table of contents generation (list of figures or tables). If you try to generate a table of contents and you keep getting  **No table of contents entries found.** try changing the separator from ";" to "," or the reverse.   
