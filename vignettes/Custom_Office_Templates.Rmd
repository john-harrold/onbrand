...
Sometimes you may wish to modify the underlying the `officer` object. When you call `save_report()`, just before writing the file, the function will look for the field `post_processing`. Here you can define R code to modify the `officer` object. Within the post-processing environment the officer object `rpt` containing your report will be available. You should modify this object to apply any changes you want made. If the post_processing element is missing or has a value of `NULL` the post-processing step will be skipped. 
