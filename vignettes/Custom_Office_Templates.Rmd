...
<<<<<<< HEAD
# Introduction <img src="data:image/png;base64,`r b64_onbrand_hex_png`" align="right" height="138.5" border="0px" />
=======
# Introduction <img src="`r file.path(package=".","figures","onbrand_hex.png")`" align="right" height="138.5" border="0px" />
>>>>>>> d2fa0f7c25c3f028b754ea4f6aad91fa667f2f26
...
<<<<<<< HEAD
![PowerPoint Slide Master Hierarchy.](data:image/png;base64,`r b64_example_layout_ppt_master_png`){width=600px}
=======
```{r, echo=FALSE, fig.cap="PowerPoint Slide Master Hierarchy", out.width = '350px'}
knitr::include_graphics(file.path(".","figures","example_layout_ppt_master.png"))
```
>>>>>>> d2fa0f7c25c3f028b754ea4f6aad91fa667f2f26
...
<<<<<<< HEAD
![Relationship between slide master names, placeholders, and content type and yaml mapping elements.](data:image/png;base64,`r b64_example_layout_yaml_pptx_png`){width=600px}
=======
...
knitr::include_graphics(file.path(".","figures","example_layout_yaml_pptx.png"))
```
>>>>>>> d2fa0f7c25c3f028b754ea4f6aad91fa667f2f26
...
<<<<<<< HEAD
![Word layout example.](data:image/png;base64,`r b64_example_layout_docx_png`){width=600px}
=======
```{r, echo=FALSE, fig.cap="Word layout example.", out.width = '600px'}
knitr::include_graphics(file.path(".","figures","example_layout_docx.png"))
```
>>>>>>> d2fa0f7c25c3f028b754ea4f6aad91fa667f2f26
