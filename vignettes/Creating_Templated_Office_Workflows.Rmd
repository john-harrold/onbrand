...
If you want to access the placeholders in PowerPoint you can use the `fph` function described above. Similarly in Word you can use the `fst` function discussed in the Word section to fetch style information.
