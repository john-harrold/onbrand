...
=======
# Introduction <img src="`r file.path(".","figures","onbrand_hex.png")`" align="right" height="138.5" border="0px" />
...
We recommend you complete the _Custom Office Templates Vignette_ prior to walking through this template. This vignette focuses on how to construct workflows using templates. Here we will use the internal templates embedded in ``onbrand``. If you want to copy them locally you can use the following commands:
...
<<<<<<< HEAD
![Example PowerPoint output for workflow above.](data:image/png;base64,`r b64_ppt_workflow_output_png`){width=600px}
=======
```{r, echo=FALSE, fig.cap="Example PowerPoint output for workflow above.", out.width = '600px'}
knitr::include_graphics(file.path(package=".","figures", "ppt_workflow_output.png"))
```
>>>>>>> d2fa0f7c25c3f028b754ea4f6aad91fa667f2f26
...
<<<<<<< HEAD
![Example Word output for workflow above.](data:image/png;base64,`r b64_doc_workflow_output_png`){width=600px}
=======
```{r, echo=FALSE, fig.cap="Example Word output for workflow above.", out.width = '600px'}
knitr::include_graphics(file.path(package=".","figures","doc_workflow_output.png"))
```
>>>>>>> d2fa0f7c25c3f028b754ea4f6aad91fa667f2f26
